...
\def\homework#1{\subfile{homework/MarkovProcess#1.tex}}
\def\to{\rightarrow}
...
\tableofcontents
\newcounter{bylsec}
\forloop{bylsec}{1}{\value{bylsec}<100}{%
  \IfFileExists{section\thebylsec.tex}{%
    \subfile{section\thebylsec.tex}%
    \newpage%
  }{}%
}
\newgeometry{left=10pt,right=10pt}
