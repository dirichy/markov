...
\begin{theorem}[\index{pu wa song sui ji ce duo de chong yao tiao jian a@普瓦松随机测度的充要条件}普瓦松随机测度的充要条件2]\label{the:普瓦松随机测度的充要条件2}
...
\end{theorem}
\begin{theorem}[\index{fu ge pu wa song guo cheng gou zao@复合普瓦松过程构造}复合普瓦松过程构造2]\label{the:复合普瓦松过程构造2}
